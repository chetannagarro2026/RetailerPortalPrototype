...
export const SUPPORT_TICKETS: SupportTicket[] = [
  {
    ...
    description: "We received size M instead of size L for the Polo shirts in PO-10042.",
    relatedDocument: "PO-10042",
    status: "Open",
    priority: "High",
    unread: true,
  ...
  },
  {
    ...
    description: "PO-10040 was supposed to include 60 Oxford Dress Shirts but we only received 57.",
    relatedDocument: "PO-10040",
    status: "Closed",
    priority: "Medium",
    unread: false,
    ...
    conversation: [
      {
        ...
        sender: "customer",
        senderName: "You",
        message: "PO-10040 was supposed to include 60 Oxford Dress Shirts but we only received 57.",
