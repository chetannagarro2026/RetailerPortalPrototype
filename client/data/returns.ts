...
export const RETURN_CLAIMS: ReturnClaim[] = [
  ...
  },
  {
    ...
    status: "Submitted",
    claimedAmount: 534,
    comment: "6 pairs arrived with visible staining on the front pocket area.",
    attachments: ["chinos-stain-1.jpg", "chinos-stain-2.jpg"],
    comments: [
      {
        id: "rc8",
        sender: "customer",
        senderName: "You",
        message: "6 pairs arrived with visible staining on the front pocket area. Photos attached.",
    ...
    comments: [
      {
        ...
        sender: "customer",
        senderName: "You",
        message: "Customers changed their minds after purchase. Requesting return of 8 units.",
      ...
      },
      {
        ...
        sender: "support",
        senderName: "Mike R.",
        message: "Unfortunately, change-of-mind returns are not covered under the return policy. This claim has been rejected.",
        timestamp: "2026-02-23T14:30:00Z",
      },
    ],
    createdAt: "2026-02-20T11:00:00Z",
    reviewedAt: "2026-02-23T14:30:00Z",
  },
];
