...
export async function createSalesOrder(params: CreateSalesOrderParams): Promise<SalesOrderResponse> {
  ...
  const payload: SalesOrderPayload = {
    ...
    cityTaxCurrencyCode: "INR",
    countyTaxAmount: 12356.00,
    countyTaxCurrencyCode: "INR",
    createDateTime: now,
    districtTaxAmount: 12356.00,
    districtTaxCurrencyCode: "INR",
    stateTaxAmount: 12356.00,
    stateTaxCurrencyCode: "INR",
    taxAmount: 12356.00,
    taxCurrencyCode: "INR",
    
    // Order totals
    orderItemTotalCurrencyCode: "INR",
    orderItemTotalSalesTaxCurrencyCode: "INR",
    orderItemTotalSalesTaxValue: "657657",
    orderItemTotalValue: parseFloat(params.totalValue.toFixed(2)),
    orderShippingTotalCurrencyCode: "INR",
    orderShippingTotalSalesTaxCode: "test",
    orderShippingTotalSalesTaxCurrencyCode: "INR",
    ...
    paymentInformations: [
      {
        ...
        authorizationAmountCurrencyCode: "INR",
    ...
    salesOrderLineItems: params.items.map((item, index) => {
      ...
      return {
        ...
        uomCode: "EA",
        unitPriceSellingAmount: parseFloat(item.unitPrice.toFixed(2)),
        unitPriceSellingAmountCurrencyCode: "INR",
        unitPriceRetailAmount: parseFloat(item.unitPrice.toFixed(2)),
        unitPriceRetailAmountCurrencyCode: "INR",
        unitPriceSuggestedRetailAmount: 12345.00,
        unitPriceSuggestedRetailAmountCurrencyCode: "INR",
        unitPriceOriginalSellingAmount: parseFloat(item.unitPrice.toFixed(2)),
        unitPriceOriginalSellingAmountCurrencyCode: "INR",
        ...
        extendedPriceSellingAmountCurrencyCode: "INR",
        extendedPriceOriginalSellingAmount: 36.67,
        extendedPriceOriginalSellingAmountCurrencyCode: "INR",
        ...
        shippingAmount: 0.00,
        shippingAmountCurrencyCode: "INR",
        shippingSalesTaxAmount: 0.00,
        shippingSalesTaxAmountCurrencyCode: "INR",
